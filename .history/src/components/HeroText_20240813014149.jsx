...
const HeroText = () => {
  return (
    <div>
      <div className="bg-black/30 absolute top-[150px] p-6 rounded-md sm:top-[250px] start-10 xl:start-16 sm:start-40 ">
        {/* Hero title */}
        <h1 className="text-[20px] lg:text-[30px] xl:text-[36px] font-primary text-white font-bold w-[300px] sm:w-[600px] mb-8">
