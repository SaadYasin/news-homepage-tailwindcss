...
const HeroText = () => {
  return (
    <div>
      <div className="bg-black/30 absolute top-[150px] p-6 rounded-lg sm:top-[250px] start-10 sm:start-40 ">
        {/* Hero title */}
        <h1 className="text-[28px] font-primary text-white font-bold w-[300px] sm:w-[600px] mb-8">
